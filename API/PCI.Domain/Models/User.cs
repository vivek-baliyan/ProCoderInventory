...
namespace PCI.Domain.Models
{
    public class User : BaseEntity
    {
        ...
        [StringLength(255)] public string ProfileImageUrl { get; set; }

        public DateTime? DateOfBirth { get; set; }

        [StringLength(100)] public string Country { get; set; }

        [StringLength(15)] public string MobileNumber { get; set; }

        [EmailAddress] [StringLength(100)] public string Email { get; set; }

        [StringLength(255)] public string StreetAddress { get; set; }
        ...
        [StringLength(255)] public string WebsiteUrl { get; set; }
        ...
        [StringLength(100)] public string LastLoginDevice { get; set; }
